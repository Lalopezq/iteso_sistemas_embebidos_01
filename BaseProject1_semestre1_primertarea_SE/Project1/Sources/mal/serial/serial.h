...
extern UINT8 *pu8SCI0_Receive_Data_ptr;
/* Pointer to actual location being read from the input buffer */
extern UINT8 *pu8SCI0_Read_Receive_Data_ptr;
/* Pointer to actual location being read from the output buffer */
extern UINT8 *pu8SCI0_Read_Transmit_Data_ptr;
/* Transmision array */
extern UINT8 u8SCI0_TxData[SCI0_TX_MAX_SIZE];
